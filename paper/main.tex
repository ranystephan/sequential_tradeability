...
simulation, but with a stricter false-discovery penalty \(\eta=0.04\).  This penalty was
chosen after a placebo stress test: sign-flipping each signal's validation returns keeps
